...
class Usuario(models.Model):
    ...
    id_pais_nacimiento = models.ForeignKey(Pais, on_delete=models.DO_NOTHING, db_column='ID_PAIS_NACIMIENTO', related_name='usuarios_nacimiento')
    id_pais_residencia = models.ForeignKey(Pais, on_delete=models.DO_NOTHING, db_column='ID_PAIS_RESIDENCIA', related_name='usuarios_residencia')
